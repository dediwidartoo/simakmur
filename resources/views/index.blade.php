...
<head>
  ...
  <title>SI MAKMUR | Sistem Informasi Kelompok Tani Makmur</title>
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Bergabung sejak
                    ...
                    {{ Auth::user()->created_at->format('d') }} {{ Auth::user()->created_at->format('M') }} {{ Auth::user()->created_at->format('Y') }}
                    @else 
                    -
                    @endif
                  </small>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">MENU ADMIN SIMAKMUR</li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('users') }}"><i class="fa fa-users"></i> Anggota</a></li>
            <li><a href="{{ route('product.index') }}"><i class="fa fa-dropbox"></i> Produk</a></li>
          </ul>
        </li>
