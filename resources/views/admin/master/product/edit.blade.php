            ...
            <form action="{{ route('product.update',$product->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="produk" class="form-control input-sm" placeholder="Nama Produk..."
                            required maxlength="60" value="{{ $product->produk }}">
                    </div>

                    <div class="form-group">
                        <label for="">Harga <span class="label-required">*</span></label>
                        <input type="number" name="harga" class="form-control input-sm" placeholder="Harga Produk..."
                            required min="0" max="9999999999" value="{{ $product->harga + 0 }}">
                    </div>

                    <div class="form-group">
                        <label for="">Stok <span class="label-required">*</span></label>
                        <input type="number" name="stok" class="form-control input-sm" placeholder="Stok Produk..."
                            required min="0" max="9999999999" value="{{ $product->stok }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" class="form-control" name="deskripsi">{{ $product->deskripsi }}</textarea>
                    </div>
                </div> <!-- /.box-body -->
